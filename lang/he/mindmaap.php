...
$string['modulename'] = 'מפות חשיבה';
$string['pluginname'] = 'מפות חשיבה';
$string['mindmaapname'] = 'שם';
$string['mindmaapname_help'] = 'שם הפעילות';
$string['mindmaapsettings'] = 'מפות חשיבה הגדרות';
$string['mindmaapfieldset'] = 'תצוגה חזותית';
$string['type'] = 'סוג';
